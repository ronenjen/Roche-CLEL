...
{
    public class UpdateAssayPlatesToReady
    {
        ...
        public async Task RunAsync(DataServicesClient client, WorkflowContext context, CancellationToken cancellationToken)
        {
            ...
            foreach (string barcode in allBarcodesArray)
            {
                ...
                cc.Properties.SetValue("Status", "Ready");
                _identityHelper.Register(cc, DestinationJobID, RequestedOrder);
            Console.WriteLine($"Plate {DestinationName} status was set to READY " + Environment.NewLine);
            }
