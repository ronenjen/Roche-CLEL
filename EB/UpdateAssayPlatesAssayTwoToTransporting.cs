...
{
    public class UpdateAssayPlatesAssayTwoToTransporting
    {

        public async Task RunAsync(DataServicesClient client, WorkflowContext context, CancellationToken cancellationToken)
        {
            string RequestedOrder = context.GetGlobalVariableValue<string>("Input.OrderId");
            string EBAssayPlateTwo = context.GetGlobalVariableValue<string>("RepTwoPlaceholderBarcodes");
            ...
            string[] allBarcodesArray = EBAssayPlateTwo.Split(new[] { "," }, StringSplitOptions.RemoveEmptyEntries);
